...
public class UsersActivity extends SuperFragment implements View.OnClickListener, TextWatcher {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.activity_users, container, false);
        tag = "UsersActivity";
        ...
        mAdapter = new UsersAdapter(MyVolley.getInstance(getContext()),getContext(),"");
    ...
    public void onClick(View v) {
        ...
        mAdapter = new UsersAdapter(MyVolley.getInstance(getContext()),getContext(),c);
        recyclerView.setAdapter(mAdapter);
    }
