...
import com.caoutch.transnet.BlockedUsersAdapter;
import com.caoutch.transnet.MyVolley;
import com.caoutch.transnet.R;
import com.caoutch.transnet.SuperFragment;
import com.caoutch.transnet.UsersAdapter;
import com.caoutch.transnet.view.LoadingRelativeLayout;

public class BlockedUsersActivity extends SuperFragment implements View.OnClickListener, TextWatcher {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.activity_blocked_users, container, false);
        tag = "BlockedUsersActivity";
        Log.i(tag, "onCreate");

        loadingRelativeLayout=root.findViewById(R.id.activity_users);
        ...
        mAdapter = new BlockedUsersAdapter(MyVolley.getInstance(getContext()),getContext(),"");
    ...
    public void onClick(View v) {
        ...
        mAdapter = new BlockedUsersAdapter(MyVolley.getInstance(getContext()),getContext(),c);
        recyclerView.setAdapter(mAdapter);
    }
